# Imaging-quality score redesign — design notes and handoff

Scope: `services/imaging_quality.py`, the per-hour 0–100 "imaging quality" score
in the weather panel. This document is the rationale for the reference
implementation delivered alongside it (`imaging_quality.py`,
`imaging_quality_examples.py`). Naming, module placement and integration are the
implementer's call; the model structure, gates and monotonicity properties are
not.
