...
### PHD2 Guide-Log Analyzer (v0.22.0 — Pass A + post-landing polish)

**Status:** `[in progress]` (Pass A shipped + polished; eight more passes planned through v0.30.0)
...
- **Frontend:** `pages/Phd2AnalyzerPage.tsx`, `components/phd2/{TimeSeriesChart,CalibrationPlot,StatsPanel,WarningsDrawer,SectionNavigator,SectionDataTab}.tsx`, `lib/phd2GuidingMetrics.ts` (client-side metrics helper for Viewport Summary + toggle-aware recompute), `api/phd2.ts`
